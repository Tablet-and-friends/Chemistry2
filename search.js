...
function Put(sel){
  if (selected==-1){
    boxes[sel].setAttribute("data-n",-1);
    boxes[sel].style.color="transparent";
    boxes[sel].innerHTML="def";
    return;
  }
...
function checkGame2(){
  ...
  /*function Rem(sel){
    if(boxes[sel].style.color!="transparent"{
    boxes[sel].style.color="transparent";
    boxes[sel].innerHTML="df";
  }
}*/
